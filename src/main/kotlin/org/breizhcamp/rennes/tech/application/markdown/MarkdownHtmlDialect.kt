...
@Component
class MarkdownHtmlDialect: AbstractProcessorDialect("Markdown Dialect", DIALECT_PREFIX, 1000) {
    companion object {
        const val DIALECT_PREFIX = "markdown"
    }

    override fun getProcessors(dialectPrefix: String?): Set<IProcessor?>? {
        return setOf(MarkdownProcessor(DIALECT_PREFIX, TemplateMode.HTML))
    }
}
